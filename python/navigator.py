...
class Navigator:
  ...
  poses = {
    ...
    "patrol4":(10.72, -7.5, 5.35, 0.329, 0.923, -0.146, 0.140),
    "patrol5":(10.925, -8.35, 5.2, 0.0, 0.707, 0.0, 0.707), # Combined Area 2 3
    "report": (11.283, -6.7607, 4.935, 0.696, 0.696, -0.123, 0.123),
  }
